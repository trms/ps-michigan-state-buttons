...
@section('content')
	...
	{!! Form::open(['route'=>'admin.buttonBar.store','method'=>'post','class'=>'form']) !!}
		...
		<!-- Form Input -->
			...
			<div class="form-group">
				...
				{!! Form::text('title','',['class' => 'form-control','placeholder'=>'required to be unique and a single word only'] ) !!}
